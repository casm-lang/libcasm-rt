...
# LIBCASM_RT_FOUND        - system has found the package
# LIBCASM_RT_INCLUDE_DIR  - the package include directory
# LIBCASM_RT_LIBRARY      - the package library

include( LibPackage )

libfind_pkg_check_modules( LIBCASM_RT_PKGCONF libcasm-rt )
...
find_library( LIBCASM_RT_LIBRARY
  NAMES libcasm-rt.so libcasm-rt.dylib libcasm-rt.dll
  PATHS ${LIBCASM_RT_PKGCONF_LIBRARY_DIRS}
  )

find_library( LIBCASM_RT_ARCHIVE
  NAMES libcasm-rt.a
  PATHS ${LIBCASM_RT_PKGCONF_LIBRARY_DIRS}
  )

set( LIBCASM_RT_PROCESS_INCLUDES LIBCASM_RT_INCLUDE_DIR )
set( LIBCASM_RT_PROCESS_LIBS     LIBCASM_RT_LIBRARY LIBCASM_RT_ARCHIVE )

libfind_process( LIBCASM_RT )

if( EXISTS "${LIBCASM_RT_LIBRARY}" AND ${LIBCASM_RT_LIBRARY} AND
    EXISTS "${LIBCASM_RT_ARCHIVE}" AND ${LIBCASM_RT_ARCHIVE} )
  set( LIBCASM_RT_FOUND TRUE PARENT_SCOPE )
else()
  set( LIBCASM_RT_FOUND FALSE PARENT_SCOPE )
endif()
