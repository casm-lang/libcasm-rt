...
TEST( libcasm_rt__instruction_gth, GthInstruction_true )
{
...
TEST( libcasm_rt__instruction_gth, GthInstruction_false )
{
    const auto a = IntegerConstant( -123 );
    const auto b = IntegerConstant( 123 );
...
TEST( libcasm_rt__instruction_gth, GthInstruction_undef_lhs )
{
    const auto a = IntegerConstant( 123 );
...
TEST( libcasm_rt__instruction_gth, GthInstruction_undef_rhs )
{
...
TEST( libcasm_rt__instruction_gth, GthInstruction_undef_both )
{
    const auto a = IntegerConstant();
    const auto b = IntegerConstant();
